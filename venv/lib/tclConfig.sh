...
# installed.
TCL_PREFIX='/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/include -fdebug-prefix-map=/var/folders/sy/f16zz6x50xz3113nwtb9bvq00000gp/T/abs_a0b3437e-5427-478c-9c0d-3bf16a61dfacwyldasds/croots/recipe/tk_1654088774077/work=/usr/local/src/conda/tk-8.6.12 -fdebug-prefix-map=/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -isystem /Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/include -mmacosx-version-min=10.9 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/lib -L/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/include'
...
TCL_PACKAGE_PATH='{/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/lib/libtclstub8.6.a'
