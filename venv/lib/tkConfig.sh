...
# installed.
TK_PREFIX='/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/sachinsen/Documents/Machine learning classes/End to End project/END to END project AWS/Diamondprediction_Docker/venv/lib/libtkstub8.6.a'
